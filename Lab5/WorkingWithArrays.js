let todos = [
    ...
    { id: 2, title: "Task 2", completed: true, description: "description for task 1"},
    { id: 3, title: "Task 3", completed: false, description: "description for task 1"},
    { id: 4, title: "Task 4", completed: true, description: "description for task 1" },
];
